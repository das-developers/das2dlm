 ...
 * Inc.  The shared object generated by this code may be loaded by closed 
 * source main programs and shared objects so long as this source code for 
 * das2dlm itself is made available to end users. 
 *
